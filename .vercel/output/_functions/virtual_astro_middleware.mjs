...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./chunks/_astro_data-layer-content_Jdh6hpMl.mjs');
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (store.hasCollection(collection)) {
      const { default: imageAssetMap } = await import('./chunks/content-assets_oHE7hoUH.mjs');
      const result = [];
...
const starlightConfig = {"defaultLocale":{"label":"简体中文","lang":"zh-CN","dir":"ltr"}};

const project = {"root":"file:///E:/claude/project2/taskora-website/","srcDir":"file:///E:/claude/project2/taskora-website/src/"};
